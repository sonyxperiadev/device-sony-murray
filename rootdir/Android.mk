...
LOCAL_SRC_FILES := vendor/etc/fstab.murray
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.murray
LOCAL_SRC_FILES := vendor/etc/init/init.murray.rc
LOCAL_MODULE_TAGS := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.murray.pwr
LOCAL_SRC_FILES := vendor/etc/init/init.murray.pwr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .rc
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR)/etc/init
